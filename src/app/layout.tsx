...
export const metadata: Metadata = {
  ...
  description: "Find your perfect car at AutoElite. Quality guaranteed vehicles, competitive financing, and exceptional service. Browse our premium inventory today.",
  keywords: "cars for sale, auto dealership, car financing, used cars, luxury vehicles, automotive",
  openGraph: {
    title: "AutoElite - Premium Cars & Expert Service",
    description: "Find your perfect car at AutoElite. Quality guaranteed vehicles, competitive financing, and exceptional service.",
    siteName: "AutoElite",
    type: "website",
    images: [
      {
